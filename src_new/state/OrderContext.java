...
public class OrderContext {
    ...
    public void removeDeliveredOrders() {
        ...
        Iterator<OrderContext> contextIterator = Database.getInstance().getOrderContexts().iterator();
        while (contextIterator.hasNext()) {
            ...
            if (isDelivered) {
                ...
                Database.getInstance().getOrders().removeIf(order -> order.getOrderId().equals(orderId));
